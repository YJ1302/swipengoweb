...
export default async function PackagesPage() {
    ...
    return (
        <div className="min-h-screen pt-20 md:pt-24">
            ...
            {/* CTA Section */}
            <section className="py-16 bg-gradient-to-r from-brand-primary to-brand-accent">
                <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
                    ...
                    <a
                        ...
                        className="inline-flex items-center space-x-2 px-8 py-4 bg-brand-navy text-white font-semibold rounded-xl shadow-lg hover:shadow-xl transform hover:scale-105 active:scale-95 transition-all duration-200"
                    >
