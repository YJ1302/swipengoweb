                        ...
                        <div className="relative w-full max-w-4xl max-h-[90vh] bg-slate-800 rounded-2xl overflow-hidden flex flex-col">
                            ...
                            <div className="flex-1 overflow-y-auto p-6 space-y-4">
                                ...
                                <div className="border border-white/10 rounded-xl p-4 bg-slate-900/30">
                                    ...
                                    <div className="mb-4">
                                        <h3 className="text-white font-medium">Itinerary Builder</h3>
                                        <p className="text-slate-400 text-sm mt-1">Add day-by-day sequence for this package</p>
                                    </div>
                                    <div className="space-y-4">
                                        ...
                                        <button 
                                            type="button" 
                                            onClick={addDay} 
                                            className="w-full mt-2 py-3 bg-white/5 border border-dashed border-white/20 text-brand-primary rounded-lg font-medium hover:bg-white/10 hover:border-brand-primary/50 transition-all flex items-center justify-center gap-2"
                                        >
                                            <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 4v16m8-8H4" />
                                            </svg>
                                            {itineraryDays.length > 0 ? "Add Another Day" : "Add First Day"}
                                        </button>
                                    </div>
                                </div>
