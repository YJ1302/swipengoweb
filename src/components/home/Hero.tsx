        ...
        <section ref={ref} className="relative min-h-screen flex items-center justify-center overflow-hidden">
            ...
            <div className="relative z-10 max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center pt-20">
                ...
                <motion.h1
                    ...
                    className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-bold text-white mb-6 tracking-tight drop-shadow-xl"
                >
                    Unforgettable
                ...
                <motion.p
                    ...
                    className="text-lg sm:text-xl text-slate-200 max-w-2xl mx-auto mb-10 leading-relaxed font-light drop-shadow-md"
                >
                ...
                <div className="mt-16">
                    <StaggerGrid className="grid grid-cols-3 gap-8 max-w-lg mx-auto" delay={1}>
                        <StaggerItem className="text-center p-4 rounded-2xl bg-brand-navy/30 backdrop-blur-sm border border-white/5 hover:bg-brand-navy/50 transition-colors">
                            <div className="text-3xl font-bold text-brand-primary">
                                <CountUp end={500} suffix="+" duration={2.5} />
                            </div>
                            <div className="text-sm text-slate-300 mt-1">Happy Travelers</div>
                        </StaggerItem>
                        <StaggerItem className="text-center p-4 rounded-2xl bg-brand-navy/30 backdrop-blur-sm border border-white/5 hover:bg-brand-navy/50 transition-colors">
                            <div className="text-3xl font-bold text-brand-primary">
                                <CountUp end={50} suffix="+" duration={2.5} />
                            </div>
                            <div className="text-sm text-slate-300 mt-1">Destinations</div>
                        </StaggerItem>
                        <StaggerItem className="text-center p-4 rounded-2xl bg-brand-navy/30 backdrop-blur-sm border border-white/5 hover:bg-brand-navy/50 transition-colors">
                            <div className="text-3xl font-bold text-brand-primary">
                                <CountUp end={5} suffix="⭐" duration={2} />
                            </div>
                            <div className="text-sm text-slate-300 mt-1">Rated Service</div>
                        </StaggerItem>
                    </StaggerGrid>
                </div>
            </div>
